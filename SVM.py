...
def Svm():
    ...
    p_model1 = SVC(kernel="poly", degree=4, gamma =0.1, C = 1000)
    #define the model for rbf kernel
    rmodel=SVC(kernel='rbf', gamma=0.1, C=1)
    rmodel1 = SVC(kernel='rbf', gamma=0.1, C=1000)
    ...
    print("poly kernel Accuracy score when gamma is: 0.1 C is :1 ", accuracy_score(prediction, test_y))
    print(prediction)
